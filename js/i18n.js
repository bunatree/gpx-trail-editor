...
const i18nMsg = (function(lang) {
  ...
  const i18nData = {
    "en": {
      ...
      "btnStop": "Stop",
      "labelSpeed": "Speed",
      "labelCameraMode": "Camera Mode",
      "labelSensitivity": "Sensitivity",
      "optCameraFixed": "Fixed View (From South)",
      "optCameraFollow": "Auto-Follow Path",
      "optCameraManual": "Manual (Free View)",
      "labelLevel": "Level",
      ...
      "alertEnabledInsertionMode": "Insertion Mode ON: Insert between No.${i} and No.${j}.",
      "alertEnabledAppendMode": "Append Mode ON: Add points to the end of the trail.",
      "alertEnabledPrependMode": "Prepend Mode ON: Add points to the start of the trail.",
      "alertDisabledInsertionMode": "Insertion/Append Mode OFF",
    ...
    "ja": {
      ...
      "btnStop": "停止",
      "labelSpeed": "再生速度",
      "labelCameraMode": "カメラモード",
      "labelSensitivity": "追従感度",
      "optCameraFixed": "固定視点 (南から)",
      "optCameraFollow": "進行方向追従",
      "optCameraManual": "自由視点 (マニュアル)",
      "labelLevel": "レベル",
      "alertEnabledDragMode": "ポイント移動モード ON: ポイントをドラッグして移動できます。",
      "alertDisabledDragMode": "ポイント移動モード OFF",
      "alertEnabledInsertionMode": "ポイント挿入モード ON: No.${i} と No.${j} の間に挿入します。",
      "alertEnabledAppendMode": "ポイント末尾追加モード ON: 軌跡の最後に追加します。",
      "alertEnabledPrependMode": "ポイント先頭追加モード ON: 軌跡の最初に追加します。",
      "alertDisabledInsertionMode": "ポイント追加/挿入モード OFF",
