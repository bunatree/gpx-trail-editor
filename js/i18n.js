...
const i18nMsg = (function(lang) {
  ...
  const i18nData = {
    "en": {
      ...
      "settingMapLayoutLabel": "Map Layout",
      "settingMapLayoutPrimary": "Left (Primary)",
      "settingMapLayoutSecondary": "Right (Secondary)",
      "settingMarkersLabel": "Markers",
      "settingColorRed": "Red",
      "settingColorPink": "Pink",
      "settingColorDarkpink": "Dark Pink",
      "settingColorOrange": "Orange",
      "settingColorYellow": "Yellow",
      "settingColorGreen": "Green",
      "settingColorTeal": "Teal",
      "settingColorBlue": "Blue",
      "settingColorCyan": "Cyan",
      "settingColorIndigo": "Indigo",
      "settingColorPurple": "Purple",
      "settingColorGray": "Gray",
      "settingMarkersBold": "Bold",
      "settingMarkersBorder": "Border",
      "settingPolylinesLabel": "Polylines",
      "settingPolylinesBold": "Bold",
      "settingPolylinesBorder": "Border",
      "settingBtnReset": "Reset to Defaults",
    ...
    "ja": {
      ...
      "settingMapLayoutLabel": "地図配置",
      "settingMapLayoutPrimary": "左 (上)",
      "settingMapLayoutSecondary": "右 (下)",
      "settingMarkersLabel": "マーカー",
      "settingColorRed": "赤",
      "settingColorPink": "ピンク",
      "settingColorDarkpink": "暗ピンク",
      "settingColorOrange": "オレンジ",
      "settingColorYellow": "黄",
      "settingColorGreen": "緑",
      "settingColorTeal": "青緑",
      "settingColorBlue": "青",
      "settingColorCyan": "水色",
      "settingColorIndigo": "紺",
      "settingColorPurple": "紫",
      "settingColorGray": "灰色",
      "settingMarkersBold": "太線",
      "settingMarkersBorder": "境界線",
      "settingPolylinesLabel": "ポリライン",
      "settingPolylinesBold": "太線",
      "settingPolylinesBorder": "境界線",
      "settingBtnReset": "既定に戻す",
